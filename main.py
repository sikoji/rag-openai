...
CHATBOT_PREPROMPT = "Namamu adalah: "+CHATBOT_NAME+" "+os.getenv("CHATBOT_PREPROMPT")+" jika pertanyaan diluar konteks anda jawab tidak tahu"
...
async def chat_with_session(session_id: int, text: str):
    ...
    combined_context = f"CONTEXT:\nKNOWLEDGE:\n{knowledge_texts}\nCHAT HISTORY:{previous_chat_texts}"
